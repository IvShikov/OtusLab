...
На устройствах Cisco протокол CDP включен по умолчанию. Нужно воспользоваться CDP, чтобы обнаружить порты, к которым подключены кабели.
 ...
 - На R1 использовали команду **show cdp interface**, чтобы определить, сколько интерфейсов включено CDP, сколько из них включено и сколько отключено.
...
**Вопрос:** Какая версия IOS используется на  S1?- Cisco IOS Software, C2960 Software (C2960-LANBASEK9-M), Version 15.0(2)SE4, RELEASE SOFTWARE (fc1)
 ...
 ![](https://github.com/IvShikov/OtusLab/blob/main/LAB14/Lab14_P2c.JPG)
 ...
 ![](https://github.com/IvShikov/OtusLab/blob/main/LAB14/Lab14_P2d.JPG)
 
 - На R1 выполнили команду **show cdp entry S1**.

 ![](https://github.com/IvShikov/OtusLab/blob/main/LAB14/Lab14_P2e.JPG)

**Вопрос:** Какие дополнительные сведения доступны теперь? - IP address : 10.22.0.2 

 - Отключили CDP глобально на всех устройствах командой **no cdp run**. 

 ![](https://github.com/IvShikov/OtusLab/blob/main/LAB14/Lab14_P2f.JPG) 
...
Данная команда не работает в Cisco Packet Tracer:
...
![](https://github.com/IvShikov/OtusLab/blob/main/LAB14/Lab14_P3c_R1.JPG)

![](https://github.com/IvShikov/OtusLab/blob/main/LAB14/Lab14_P3c_S1.JPG)

![](https://github.com/IvShikov/OtusLab/blob/main/LAB14/Lab14_P3c_S2.JPG)
...
![](https://github.com/IvShikov/OtusLab/blob/main/LAB14/Lab14_P4S1.JPG)
...
![](https://github.com/IvShikov/OtusLab/blob/main/LAB14/Lab14_P4_S1-3_R1.JPG)
...
![](https://github.com/IvShikov/OtusLab/blob/main/LAB14/Lab14_P4S5_S1a2.JPG)
