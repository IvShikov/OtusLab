...
Нам удалось установить SSH-соединение с коммутатором.

![](https://github.com/IvShikov/OtusLab/blob/main/LAB5/Lab5_P3_S3.JPG)
...
![](https://github.com/IvShikov/OtusLab/blob/main/LAB5/Lab5_P4.JPG)

#### При использовании интерфейса командной строки поддерживаются  версии V1 и V2 протокола SSH 
