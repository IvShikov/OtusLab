...
Отправили с PC-A команду **ping** на маршрутизатор R1. Если эхо-запрос с помощью команды ping не проходит, найдите и устраните неполадки подключения.
...
#### При использовании интерфейса командной строки поддерживаются   версии протокола SSH  
Закрыли окно настройки.
