...
Интерфейсы F0/6 на S1 и F0/18 на S2 настроены как порты доступа. На этом шаге мы также настроим безопасность портов на этих двух портах доступа.
 - На S1 ввели команду show port-security interface f0/6 для отображения настроек по умолчанию безопасности порта для интерфейса F0/6. Записали ответы ниже.
...
конфигурацию.
 ...
 - Настроили следующие параметры безопасности порта на S2 F / 18:
