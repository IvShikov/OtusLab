...
|Узнаем широковещательный IPv4-адрес в этой подсети, заменив 0 на 1 в порции хоста по количеству бит узлов в подсети  |11000000.10101000.11001000.11111111 |
#
Переведём полученные данные в десятичную систему и заполним таблицу "Найти". Запишем также IPv4-адрес первого узла в этой подсети (больше на 1 сетевого адреса новой подсети) и IPv4-адрес последнего узла в этой подсети (меньше на 1 широковещательного IPv4-адреса). 
# 
