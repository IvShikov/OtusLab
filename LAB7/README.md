...
![](https://github.com/IvShikov/OtusLab/blob/main/LAB7/Lab7_P2_S4_Scheme%20to%20fulfill.jpg)
...
Корневыми портами на коммутаторах являются порт f0/4 свитча S3, f0/2 свитча S1 и f0/2 свитча S2.
Назначенными портами на коммутаторе являются порт f0/4 свитча S1 и f0/4 свитча S2.
