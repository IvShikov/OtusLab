...
## Часть 2. Создание сетей VLAN и назначение портов коммутатора
Во второй части мы создали VLAN, как указано в таблице выше, на обоих коммутаторах. Затем назначили VLAN соответствующему интерфейсу и проверили настройки конфигурации. Выполнили следующие задачи на каждом коммутаторе.
...
#### Вопрос: Если G0/0/1 на R1 будет отключен, ?



## Часть 4. Настройка маршрутизации между сетями VLAN
### Шаг 1. Настройка маршрутизатора.
 - *При необходимости* активировали интерфейс G0/0/1 на маршрутизаторе.
...
## Часть 5. Проверка работоспособности маршрутизации между VLAN
### Шаг 1. Выполнение тестов с PC-A. Всё должно быть успешно.
...
#### В результатах отображаются Какие промежуточные IP-адреса  ?
